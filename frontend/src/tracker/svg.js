...
<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 5l7 7-7 7M5 5l7 7-7 7" /></svg>

export { PlusCircleSvg, MinusCircleSvg, PlusSvg, MinusSvg, XSvg, ChevronDown, ChevronUp, ChevronLeft, HamburgerSvg, CollectionSvg, CubeTransparentSvg, TableSvg, SwitchVerticalSvg, ChevronDoubleDownSvg, ChevronDoubleRight }